      ...
      <>
        ...
        >
          <PackageWrapper>
            ...
            <SubHeadingStyle>
              Structuring your website with multiple pages enables you to guide
              a user through vital information until they hit the call to
              action. Many websites do this well, join them.
            </SubHeadingStyle>
            <PackageContainer>
              <div>
                ...
                <ParagraphStyle>
                  ...
                  buying a service or product. Guiding them through the website
                  to make contact is difficult but very doable. Good design,
              ...
              <div>
                ...
                <ParagraphStyle>
                  With multiple pages, you have different places where your
                  customer can land. Each page should have the same goal of
                  converting in mind yet maintain the integrity of your business
                  on that given page. More page on your site equals more pages
                  that can rank in search engine results.
                </ParagraphStyle>
              </div>
            </PackageContainer>
          </PackageWrapper>
          ...
          <PackageWrapper>
            <HowListContainer>
              ...
              <HowList>
                <HowListItem>
                  Keywords from each page have the ability to rank in Google. 5
                  more pages equals 5 times the organic traffic (if done right).
                </HowListItem>
                <HowListItem>
                ...
                <HowListItem>
                  All of your information is on your website, landing pages can
                  be purchased in the future for specific campaigns.
                </HowListItem>
                <HowListItem>
                  Your website will seem more professional than the rest. As
                  said earlier, showcase websites only get so far.
                </HowListItem>
              </HowList>
              <SubHeadingStyle>
